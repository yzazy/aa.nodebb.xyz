...
import xyz.nodebb.aa.R;
import xyz.nodebb.aa.WebAppApplication;
import xyz.nodebb.aa.WebAppConfig;
import xyz.nodebb.aa.utility.DownloadUtility;
import xyz.nodebb.aa.utility.MediaUtility;
import xyz.nodebb.aa.utility.NetworkManager;
import xyz.nodebb.aa.view.ViewState;
...
public class MainFragment extends TaskFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            WebView webView = mRootView.findViewById(R.id.fragment_main_webview);
    ...
    private void showContent() {
        // Show Content
        ViewGroup containerContent = mRootView.findViewById(R.id.container_content);
        ViewGroup containerProgress = mRootView.findViewById(R.id.container_progress);
        ViewGroup containerOffline = mRootView.findViewById(R.id.container_offline);
        ViewGroup containerEmpty = mRootView.findViewById(R.id.container_empty);
    ...
    private void renderView() {
        // References
        final WebView webView = mRootView.findViewById(R.id.fragment_main_webview);
        final AdView adView = mRootView.findViewById(R.id.fragment_main_adview);
    ...
    private boolean isLinkExternal(String url) {
        if(url.startsWith("http://magictea.xyz")||url.startsWith("https://magictea.xyz")){
            return true;
        }else {
