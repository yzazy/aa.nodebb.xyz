...
public class DrawerAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder.titleTextView = view.findViewById(R.id.drawer_item_title);
            holder.iconImageView = view.findViewById(R.id.drawer_item_icon);
            view.setTag(holder);
        }
